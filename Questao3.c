...
#include <string.h>
#include <stdlib.h>
#include <ctype.h> // inclui a biblioteca ctype.h para usar a função isdigit

int main() {
    char placa[9], dia_da_semana[20];
    int ultimo_numero, numero_do_dia;
    char letras[4], numeros[5]; // cria duas strings para armazenar as letras e os números da placa
    int n; // cria uma variável para armazenar o número de itens lidos pela função sscanf
    int dia_valido = 1; // cria uma variável booleana para indicar se o dia da semana é válido ou não
    int placa_valida = 1; // cria uma variável booleana para indicar se a placa é válida ou não
